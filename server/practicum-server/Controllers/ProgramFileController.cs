...
namespace practicum_server.Controllers
{
    ...
    public class ProgramFileController : ControllerBase
    {
        ...
        // GET api/<ProgramFileController>/5
        [HttpGet("{id}")]
        ...
        // POST api/<ProgramFileController>
        [HttpPost]
        public void Post([FromBody] string value)
        {
        }

        // PUT api/<ProgramFileController>/5
        [HttpPut("{id}")]
        public void Put(int id, [FromBody] string value)
        {
        }

        // DELETE api/<ProgramFileController>/5
        [HttpDelete("{id}")]
